...
def lambda_handler(event, context):
    ...
    try:
        ...
        MIN_ITEMS_TO_PROCESS = int(transform_info["min_items_process"]["stage_{}".format(stage[-1].lower())])
        MAX_ITEMS_TO_PROCESS = int(transform_info["max_items_process"]["stage_{}".format(stage[-1].lower())])
