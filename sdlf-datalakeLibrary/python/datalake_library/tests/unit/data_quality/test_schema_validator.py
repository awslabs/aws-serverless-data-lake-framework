...
class TestParquetSchemaValidator:
    ...
    def test_validation_off(mocker):
        mocker.patch(
            ...
            return_value={"Table": {"Parameters": {"validate_schema": "false"}}},
        )
        mocker.patch("awswrangler.s3.read_parquet_metadata", return_value=({}, None))
    ...
    def test_validation_failure_different_types(mocker):
        ...
        mocker.patch(
            ...
            return_value=({"Op": "string", "last_modified_at": "timestamp", "id": "string"}, None),
        )
