...
class SdlfStageEmrserverless(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        postmetadatastep_role_policy = iam.Policy(self, f"sdlf-{p_teamname.value_as_string}-{p_pipeline.value_as_string}-postupdate-{p_stagename.value_as_string}",
            statements=[
                iam.PolicyStatement(
...
#            retention=Duration.days(p_cloudwatchlogsretentionindays.value_as_number),
        ...
        errorstep_role_policy = iam.Policy(self, f"sdlf-{p_teamname.value_as_string}-{p_pipeline.value_as_string}-error-{p_stagename.value_as_string}",
            statements=[
                iam.PolicyStatement(
                    actions=[
                        "sqs:DeleteMessage",
...
#           Value: !Ref rLambdaErrorStep
        ...
        ######## STATE MACHINE #########
        statemachine_role_policy = iam.Policy(self, f"sdlf-{p_teamname.value_as_string}-states-execution",
            statements=[
                iam.PolicyStatement(
        ...
        emrserverless_role = iam.Role(self, "rEmrServerlessExecutionRole",
            assumed_by=iam.PrincipalWithConditions(
        ...
        statemachine = sfn.StateMachine(self, "rStateMachine",
            ...
            definition_body=sfn.DefinitionBody.from_file(os.path.join(dirname, "state-machine/stage-emrserverless.asl.json")),
        ...
        routingstep_role_policy = iam.Policy(self, f"sdlf-{p_teamname.value_as_string}-{p_pipeline.value_as_string}-routing-{p_stagename.value_as_string}",
            statements=[
                iam.PolicyStatement(
                    actions=[
                        "sqs:DeleteMessage",
