...
class SdlfStageEcsfargate(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        postmetadatastep_role_policy = iam.Policy(self, f"sdlf-{p_teamname.value_as_string}-{p_pipeline.value_as_string}-metadata-{p_stagename.value_as_string}",
            statements=[
                iam.PolicyStatement(
...
#           Value: !Ref rLambdaErrorStep
        ...
        statemachine = sfn.StateMachine(self, "rStateMachine",
            ...
            definition_body=sfn.DefinitionBody.from_file(os.path.join(dirname, "state-machine/stage-ecsfargate.asl.json")),
